...
<!--===============================================================================================-->
<html lang="en">
    <div class="hero-wrap hero-bread" style="background-image: url('../assets/images/landscape 2.jpg');">
      <div class="container">
				...
				<div class="row justify-content-center">
					<div class="col-md-10 mb-5 text-center">
						<ul class="product-category">
							...
							<li><a href="shopVegetables.php" class="active"  name="Vegetables">Vegetables</a></li>
							<li><a href="shopfruits.php" name="Fruits">Fruits</a></li>
							<li><a href="shopfish.php" name="Fish">Fish</a></li>
					...
					require_once '../ctmls.io';
					     $query = "SELECT * FROM `sellaproduct` where Category='Vegetables';";
