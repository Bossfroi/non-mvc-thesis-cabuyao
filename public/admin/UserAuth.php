...
<center>
          ...
          <p class="lead text-muted">Username:<?php echo base64_decode( $row['username']) ?></p>
          ...
          <p class="lead text-muted">Phone#: <?php echo $row['Phone'] ?></p>
            ...
            <p class="lead text-muted"><?php echo'<img src="data:image/jpeg;base64,' .base64_encode($row['ValidID']).'" height="150" width="250"/>';
						 ?><?php echo'<img  src="data:image/jpeg;base64,' .base64_encode($row['Photo']).'" height="150" width="200"/>'; ?></p>
            <p>
