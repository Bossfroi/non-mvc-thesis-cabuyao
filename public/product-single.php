    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="assets/images/product-1.jpg" class="image-popup"><img src="assets/images/malaking sili.jpg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="assets/img-fluid" src="assets/images/product-1.jpg" alt="Colorlib Template">
